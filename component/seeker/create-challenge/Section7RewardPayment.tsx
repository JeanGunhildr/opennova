...
export default function Section7RewardPayment({
  rewardAmount,
  selectedBank,
  paymentStatus,
  onReward,
      ...
      <div style={CARD_STYLE}>
        ...
        <div className="flex items-start gap-[10px] mb-4">
          ...
          <div>
            ...
            >
              Nominal hadiah challenge dan penyelesaian pembayaran.
            </p>
          </div>
        </div>
        ...
        <div className="mb-4">
            ...
            {isSpecial && (
              <span
                ...
                style={{
                  height: "24px",
                  padding: "0 9px",
                  background: "rgba(216,200,58,0.12)",
                  border: "1px solid rgba(216,200,58,0.3)",
                  color: "#D8C83A",
                  fontSize: "10px",
                  fontWeight: 700,
                }}
          ...
          <div
            className="flex items-center rounded-[9px] overflow-hidden"
            style={{
              height: "40px",
              background: "#171717",
              border: "1px solid #373737",
          ...
          >
            ...
            <input
              ...
              min={0}
              onChange={(e) =>
                handleRewardChange(e.target.value)
              }
              onFocus={(e) => {
          ...
          {isSpecial && (
            ...
            >
              Hadiah mencapai ambang Kolaborasi Spesial dan mendapat
              prioritas penempatan Solver.
            </p>
          )}
        </div>
        ...
        {/* Calculation */}
        <div
          className="rounded-[9px] p-[10px] mb-3"
          style={{
            background: "#232323",
            border: "1px solid #373737",
          }}
        >
          <div className="flex items-center justify-between mb-1">
            ...
            >
              {rewardAmount > 0 ? fmt(rewardAmount) : "—"}
            </span>
          </div>
        ...
        >
          ...
          >
            Dana hadiah disimpan dalam escrow dan diserahkan kepada
            pemenang setelah challenge selesai.{" "}
            <button
              type="button"
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span
            className="inline-flex items-center h-[24px] px-3 rounded-full text-[11px] font-semibold"
            style={
              paymentStatus === "paid"
                ? {
                    background: "#143520",
