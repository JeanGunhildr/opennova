...
function CriteriaStage({
  ...
  criteria: Criterion[];
  weight: number;
  onCriteria: (c: Criterion[]) => void;
  onWeight: (w: number) => void;
  otherSetter: (w: number) => void;
    ...
    <div>
      ...
      <div className="flex flex-col gap-2 mb-2">
        {criteria.map((c) => (
          <div
            key={c.id}
            className="rounded-[9px] p-2 flex flex-col gap-[7px]"
            style={{
              background: "#171717",
              border: "1px solid #373737",
            }}
      ...
      <div
        ...
        style={{
          gridTemplateColumns: "34px minmax(0,1fr) 60px",
        }}
      >
        <button
          type="button"
        ...
        >
          <input
            type="number"
            name={label === "Penjurian Ahli" ? "expert_weight" : "pitch_weight"}
            value={weight}
            min={0}
            max={100}
...
export default function Section5Evaluation({
  expertCriteria,
  expertWeight,
  pitchCriteria,
  pitchWeight,
    ...
    <div style={CARD_STYLE}>
      <div className="flex items-start gap-[10px] mb-4">
        ...
        <div>
          ...
          >
            Poin penilaian dalam tahap Penjurian Ahli dan Pitching Final.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-5">
        <CriteriaStage
          ...
          weight={expertWeight}
          onCriteria={onExpertCriteria}
          onWeight={onExpertWeight}
          otherSetter={onPitchWeight}
          criterionName="expert_criteria"
          descriptionName="expert_criteria_description"
        />
        ...
        <CriteriaStage
          ...
          weight={pitchWeight}
          onCriteria={onPitchCriteria}
          onWeight={onPitchWeight}
          otherSetter={onExpertWeight}
          criterionName="pitch_criteria"
          descriptionName="pitch_criteria_description"
        />
      </div>
