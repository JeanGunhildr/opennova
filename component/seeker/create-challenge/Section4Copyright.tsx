...
export default function Section4Copyright({
  copyrightFile,
  onFile,
}: Section4Props) {
  ...
  function validateAndSet(file: File) {
    ...
    if (file.type !== "application/pdf") {
      setFileError("Hanya file PDF yang diterima.");
      return;
    }

    if (file.size > 50 * 1024 * 1024) {
      setFileError("Ukuran maksimal 50MB.");
      return;
    }
      ...
      {copyrightFile ? (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {(copyrightFile.size / (1024 * 1024)).toFixed(2)} MB
            </p>
          </div>

          <span style={{ color: "#54D67A" }}>
            <CheckCircle2
              size={18}
              strokeWidth={2.2}
            />
