...
export default function CreateChallengeHeader({ onDiscard, onPublish }: CreateChallengeHeaderProps) {
  return (
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-[10px] flex-shrink-0">
          <button type="button" onClick={onDiscard}
            className="inline-flex items-center justify-center rounded-full text-[13px] font-semibold transition-colors"
          ...
          <button type="button" onClick={onPublish}
            className="inline-flex items-center justify-center rounded-full text-white text-[13px] font-semibold bg-[#E30000] hover:bg-[#CC0000] transition-colors"
            style={{ height: "44px", padding: "0 18px" }}>
            Publikasikan Challenge
          </button>
        </div>
      </div>
    </div>
