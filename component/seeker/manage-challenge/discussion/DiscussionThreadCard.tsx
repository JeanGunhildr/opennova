...
import type { SeekerDiscussionThread } from "@/lib/actions/seeker-discussion";
import InlineReplyComposer from "./InlineReplyComposer";

interface DiscussionThreadCardProps {
  thread: SeekerDiscussionThread;
  companyName: string;
...
export default function DiscussionThreadCard({
  ...
  const isOfficial = thread.authorRole === "Seeker";
  ...
  return (
    <div className="border-b border-[#2E2E2E] pb-5 mb-5 last:border-b-0 last:pb-0 last:mb-0">
      ...
      <div>
        ...
        {/* Thread Action: "Balas" button — only for Solver threads */}
        {!isOfficial && (
